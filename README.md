...
- 📅 **Event System**: Create and manage campus events
...
For detailed setup instructions including Supabase and Kakao OAuth configuration, see [SETUP_GUIDE.md](SETUP_GUIDE.md).
