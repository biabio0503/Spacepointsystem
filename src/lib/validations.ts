...
export const createEventSchema = z.object({
   ...
   date: z.string().datetime('올바른 날짜 형식이 아닙니다').or(z.date()),
   ...
   postDate: z.string().datetime('올바른 날짜 형식이 아닙니다').or(z.date()),
   postEndDate: z.string().datetime('올바른 날짜 형식이 아닙니다').or(z.date()),
});
...
export const createRentalSchema = z.object({
   ...
   expectedReturnDate: z.string().datetime('올바른 날짜 형식이 아닙니다').or(z.date()),
